 ...
 */
export type CreatePathAnimationOptions = CreateCurveAnimationClipOptions_Base & CreateKeyframeTrackOptions_Base & PathAnimationTimeOptions & CurveOptions & PolylineOptions & SampleOptions & GetKeyframeTransformDatasOptions_Base
...
/**
 * createBonePathAnimation 的额外选项
 */
export interface CreateBonePathAnimationOptions_Base {
    /**
     * 模型对象
     * @remarks
...
/**
 * createChainBones 的选项
 */
export interface CreateChainBonesOptionsByAxials {
 ...
 * 等分链式骨骼选项
 */
export interface EqualChainBoneOptions {
 ...
 * 以关节位置来定义骨骼的选项
 */
export type CreateChainBonesOptions = {
    /**
     * 关节位置列表
     */
    joints?:Vector3[]|null;
