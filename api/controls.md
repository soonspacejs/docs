...
{ prop: 'distance', desc: '相机 `position` 与 `target` 的距离', type: 'number', require: false, default: '' },
...
{ prop: 'polarAngle', desc: '当前的极角弧度', type: 'number', require: false, default: '' },
...
{ prop: 'azimuthAngle', desc: '当前的方位角弧度', type: 'number', require: false, default: '' },
